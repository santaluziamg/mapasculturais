...
class Theme extends BaseV1\Theme{
    ...
    protected static function _getTexts(){
        ...
        return array(
            ...
            'home: colabore' => "Colabore com o Mapeando Cultura,

            'home: abbreviation' => "SMC",
            'home: home_devs' => 'Existem algumas maneiras de desenvolvedores interagirem com o Mapeando Cultura. A primeira é através da nossa <a href="https://github.com/hacklabr/mapasculturais/blob/master/doc/api.md" target="_blank">API</a>. Com ela você pode acessar os dados públicos no nosso banco de dados e utilizá-los para desenvolver aplicações externas. Além disso, o SP Cultura é construído a partir do sofware livre <a href="http://institutotim.org.br/project/mapas-culturais/" target="_blank">Mapas Culturais</a>, criado em parceria com o <a href="http://institutotim.org.br" target="_blank">Instituto TIM</a>, e você pode contribuir para o seu desenvolvimento através do <a href="https://github.com/hacklabr/mapasculturais/" target="_blank">GitHub</a>.',
    ...
    function _init() {
        ...
        $app->hook('view.render(<<*>>):before', function() use($app) {
            $this->jsObject['assets']['logoSantaluzia'] = $this->asset('img/logoSantaluzia.png', false);
        });
        ...
        $app->hook('GET(project.virada-cultural-2015.docx)', function() use($app, $theme) {
            ...
            $parceiros = [
                'LAB.RIO' => [],
                'HACKLAB' => [],
                'Secretaria da Cultura do Municipal de Santa Luzia' => [],
